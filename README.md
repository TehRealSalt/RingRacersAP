...
See here for a guide on how to install and use: [Dr. Robotnik's Ring Racers Randomizer Setup Guide](https://github.com/TehRealSalt/RingRacersAP/blob/master/apworld/docs/setup_en.md)
